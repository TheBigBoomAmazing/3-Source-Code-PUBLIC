(function ($) {
    ...
    LG.prevDialogImage = function (rootPath) {
        rootPath = rootPath || "";
        LG.prevLoadImage(rootPath + 'styles/liger/Aqua/images/win/', ['dialog-icons.gif']);
        LG.prevLoadImage(rootPath + 'styles/liger/Gray/images/win/', ['dialogicon.gif']);
    };
    ...
    LG.FTValidate = function(form,options)
    {
        if (typeof (form) == "string")
            form = $(form);
        else if (typeof (form) == "object" && form.NodeType == 1)
