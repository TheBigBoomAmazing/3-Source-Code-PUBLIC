...
namespace Suzsoft.Smart.EntityCore
{
    ...
    public class TableInfo
    {
        ...
        protected List<ColumnInfo> _noIdentityColumnInfo;
        /// <summary>
        /// 除去自增列
        /// </summary>
        public List<ColumnInfo> NoIdentityColumnInfo
        {
            get
            {
                if (_noIdentityColumnInfo == null)
                {
                    _noIdentityColumnInfo = new List<ColumnInfo>();
                    foreach (ColumnInfo ci in _columns.Values)
                    {
                        if (!ci.IsIdentity)
                        {
                            _noIdentityColumnInfo.Add(ci);
                        }
                    }
                }
                return _noIdentityColumnInfo;
            }
        }
