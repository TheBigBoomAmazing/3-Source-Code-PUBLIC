...
namespace Suzsoft.Smart.EntityCore
{
        ...
        where T : EntityBase, new()
    {
        ...
        public static List<T> DataTable2List(DataTable table)
        {
        ...
        public static DataTable List2DataTable(List<T> list)
        {
            T schema = new T();
        ...
        public DataTable ToDataTable()
        {
            ...
            foreach (ColumnInfo field in schema.OringTableSchema.AllColumnInfo)
            {
                table.Columns.Add(field.ColumnName, field.DataType);
            }
            foreach (T t in this)
            {
                DataRow row = table.NewRow();
        ...
        public DataSet ToDataSet()
        {
            ...
            result.Tables.Add(this.ToDataTable());
            return result;
        }
    }
}