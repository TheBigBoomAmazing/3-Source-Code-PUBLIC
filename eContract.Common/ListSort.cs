...
namespace eContract.Common.WebUtils
{
    ...
    public class IListSort<T>
    {
        ...
        {
            if (string.IsNullOrEmpty(_propertyName)) throw new ArgumentNullException("The object is not to find the specified property!");
            PropertyInfo property = typeof(T).GetProperty(_propertyName);
            if (property == null) throw new ArgumentNullException("The object is not to find the specified property!");
